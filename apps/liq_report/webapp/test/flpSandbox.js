					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Informe de liquidez",
									"targetURL": "#liqreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"liqreport-display": {
								"semanticObject": "liqreport",
								"action": "display",
								"description": "Informe de liquidez",
								"title": "Informe de liquidez",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=liqreport",
									"url": sap.ui.require.toUrl("liqreport")
								}
							}
						}
					}
