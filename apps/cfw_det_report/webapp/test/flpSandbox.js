		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Detalle del informe de posición",
									"targetURL": "#cfwdetreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cfwdetreport-display": {
								"semanticObject": "cfwdetreport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cfwdetreport",
									"url": sap.ui.require.toUrl("cfwdetreport")
								}
							}
						}
					}
