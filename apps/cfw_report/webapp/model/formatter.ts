...
export default {
    enabledInputHierLiqItem: function (this: MainController, hierarchySelected: boolean): boolean {
        ...
        if (ownerComponent.queryModel.getProperty(
    ...
    enabledInputBankItem: function (this: MainController, hierarchySelected: boolean): boolean {
        const ownerComponent = (<AppComponent>this?.getOwnerComponent());
