					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Informe de provisión y previsión",
									"targetURL": "#cfwreport-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"cfwreport-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cfwreport",
									"url": sap.ui.require.toUrl("cfwreport")
								}
							}
						}
					}
